...
import { View, Text, TextInput, Button, FlatList, SafeAreaView, KeyboardAvoidingView } from 'react-native';
...
const CommentsPage = () => {
    ...
    useEffect(() => {
        const fetchPublication = async () => {
            ...
            const q = query(commentsRef, where("idPublication", "==", publicationId));
